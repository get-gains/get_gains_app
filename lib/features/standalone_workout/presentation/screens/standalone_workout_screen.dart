...
class _StandaloneWorkoutScreenState
  ...
  Future<void> _logSet(int exerciseIndex, int setIndex) async {
    ...
    final result = await repo.logSet(
      workoutSessionModelId: _session.id,
      routineExerciseModelId: exercise.id,
      setNumber: setData.setNumber,
      repsCompleted: setData.reps,
      weightKg: setData.weight > 0 ? setData.weight : null,
      rpe: setData.rpe,
      exerciseNameSnapshot: exercise.exercise?.name,
      ...
      success: (performedSet) {
        setState(() {
          ...
          _session = _session.copyWith(
            performedSets: [..._session.performedSets, performedSet],
          );
        });

        // Auto-advance to next incomplete exercise if this one is done
        ...
        if (completedInExercise >= exercise.sets) {
          final nextIncomplete = widget.exercises.indexWhere(
            (ex) {
              ...
              final completed = _exerciseSets[idx]
                  .where((s) => s.isCompleted)
                  .length;
        ...
        builder: (ctx) => AppDialogContent(
          ...
          contentWidget: Column(
            ...
            children: [
              ...
              // Reusing a simple TextField since AppTextField may need specific imports
              TextField(
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context, bool isDark) {
    ...
    final completedSets = _session.completedSetsCount;
        ...
        children: [
          ...
          ...List.generate(sets.length, (setIndex) {
            ...
            return SetInputRow(
              ...
              onTap: () {
                // No-op for standalone; active set is determined by completion order
              },
            );
          }),
          ...
          // Quick complete button for first incomplete set
