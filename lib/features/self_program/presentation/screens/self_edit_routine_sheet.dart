...
Future<bool?> showSelfEditRoutineSheet({
  ...
  return showAppBottomSheet<bool>(
    context: context,
    builder: (ctx) => _SelfEditRoutineSheet(
...
class _SelfEditRoutineSheet extends ConsumerStatefulWidget {
  const _SelfEditRoutineSheet({
  ...
  @override
  ConsumerState<_SelfEditRoutineSheet> createState() => _SelfEditRoutineSheetState();
}

class _SelfEditRoutineSheetState extends ConsumerState<_SelfEditRoutineSheet> {
